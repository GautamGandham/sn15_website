...
const VadaDispenser: React.FC = () => {
  const features = [
    'Automated vada shaping and dispensing',
    'AI quality and temperature control',
    'Consistent portions for every serve',
    'Safety-first cooking cycle automation',
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium">
                <Package className="w-4 h-4" /> Smart Food Prep
              </div>
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">Vada Dispenser</h1>
